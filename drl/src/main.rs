...
fn main() {
    ...
    */
    ...
    let (Q, Pi) = algorithms::monte_carlo_control_with_exploring_starts(&lw, None, Some(5000));
    ...
    let lw = line_world::init(5);
    let (Q, Pi) = algorithms::monte_carlo_control_on_policy(&lw, None, Some(5000), None);
    println!("Action value optimale:\r\n{}", Q);
    println!("Policy optimale:\r\n {}", Pi);
    ...
    let lw = line_world::init(5);
    let (Q, Pi) = algorithms::monte_carlo_control_off_policy(&lw, None, Some(5000));
    println!("Action value optimale:\r\n{}", Q);
    println!("Policy optimale:\r\n {}", Pi);
    ...
    /*println!("---------------SARSA------------------");
    let lw = line_world::init(5);
    let Q = algorithms::sarsa(&lw, None, Some(100), None, None, None);
    println!("Action value optimale:\r\n{}", Q);
    //println!("Policy optimale:\r\n {}", Pi);

    let lw = grid_world::init(3, 3);
    let Q = algorithms::sarsa(&lw, None, Some(1000), None, None, None);
    println!("Action value optimale:\r\n{}", Q);
    //println!("Policy optimale:\r\n {}", Pi);*/
    ...
    let lw = line_world::init(5);
    println!("Line World:");
    let Q = algorithms::q_learning(&lw, None, Some(100), None, None, None);
    println!("Action value optimale:\r\n{}", Q);
    //println!("Policy optimale:\r\n {}", Pi);

    let lw = grid_world::init(3, 3);
    println!("Grid World:");
    let Q = algorithms::q_learning(&lw, None, Some(150), None, None, None);
    println!("Action value optimale:\r\n{}", Q);
    //println!("Policy optimale:\r\n {}", Pi);*/
    ...
    /*println!("---------------DYNA-Q------------------");
    let lw = line_world::init(5);
    let Q = algorithms::dyna_q(&lw, None, Some(100), Some(50), None, None);
    println!("Action value optimale:\r\n{}", Q);
    //println!("Policy optimale:\r\n {}", Pi);

    let lw = grid_world::init(3, 3);
    let Q = algorithms::dyna_q(&lw, Some(0.95), Some(100), Some(50), None, None);
    println!("Action value optimale:\r\n{}", Q);*/
    //println!("Policy optimale:\r\n {}", Pi);*/
}
